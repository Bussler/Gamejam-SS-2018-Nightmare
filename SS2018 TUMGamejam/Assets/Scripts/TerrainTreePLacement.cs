...
public class TerrainTreePLacement : MonoBehaviour {
    ...
    public void Place()
    {
        ...
        for(int i=0; i < numberOfObjects; i++)
        {
            ...
            GameObject newObject = (GameObject)Instantiate(objectToPlace, new Vector3(posx, posy, posz), new Quaternion(0, Random.Range(0, 360), 0, 1));
            currentObjects += 1;
        ...
        for(int i=0; i < numberOfsecondObject; i++)
        {
            ...
            float posy = Terrain.activeTerrain.SampleHeight(new Vector3(posx, 0, posz));
            // create new gameObject on random position
            GameObject newObject = (GameObject)Instantiate(secondObjectToPlace, new Vector3(posx, posy, posz),new Quaternion(0,Random.Range(0,360),0,1));
            currentObjects += 1;
